...
export default function AddMovie() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (youtubeError) {
      alert('Veuillez corriger l\'erreur YouTube avant de continuer');
      return;
    }
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="bg-zinc-900 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-black">Ajouter un film</h1>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">
              Genres (sélectionnez-en plusieurs)
            </label>
          ...
          <div>
            ...
            <div className="mt-2 space-y-2">
              <p className="text-sm text-zinc-400">
                💡 <strong>Vous pouvez coller :</strong>
              </p>
              <ul className="text-sm text-zinc-500 space-y-1 ml-4">
                <li>✅ Le lien complet : <code className="text-cyan-400">https://www.youtube.com/watch?v=Way9Dexny3w</code></li>
                <li>✅ Le lien court : <code className="text-cyan-400">https://youtu.be/Way9Dexny3w</code></li>
                <li>✅ Juste l'ID : <code className="text-cyan-400">Way9Dexny3w</code></li>
              </ul>
            </div>
            ...
            {/* 🆕 Message de succès */}
            {formData.youtube_id && !youtubeError && !youtubeValidating && (
              <div className="mt-3 p-3 bg-green-600/20 border border-green-600/30 rounded-lg">
                <p className="text-sm text-green-300 font-semibold">✅ Vidéo YouTube valide !</p>
              </div>
            )}
          ...
          <div className="flex items-center gap-3 p-4 bg-zinc-900 rounded-lg border border-white/10">
            ...
            <label htmlFor="is_featured" className="font-semibold cursor-pointer">
              ⭐ Mettre en vedette (Hero section)
            </label>
          </div>
          ...
          <div className="flex gap-4 pt-6">
            <button
              type="submit"
              disabled={loading || youtubeValidating || youtubeError}
          ...
          {youtubeError && (
            <div className="p-4 bg-yellow-600/20 border border-yellow-600/30 rounded-lg">
              <p className="text-sm text-yellow-300">
                ⚠️ <strong>Attention :</strong> Le bouton d'ajout est désactivé tant que l'erreur YouTube n'est pas corrigée.
              </p>
            </div>
          )}
        </form>
